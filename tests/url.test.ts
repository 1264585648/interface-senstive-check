...
describe('sanitizeUrl', () => {
  ...
  it('redacts common sensitive or opaque path identifiers', () => {
    ...
    expect(sanitizeUrl('https://example.com/users/alice')).toBe('https://example.com/users/:redacted');
  ...
  it('keeps ordinary route segments readable', () => {
    ...
    expect(sanitizeUrl('https://example.com/users/detail')).toBe('https://example.com/users/detail');
  });
});
